...
class AGroupController extends Controller
{
    ...
    public function getAllGroups(): \Illuminate\Http\Response
    {
        ...
        return self::returnData('groups',GroupResource::collection($groups),'all groups',200);
    }
    ...
    {
        $group = $this->group->find($id);
        return self::returnData('users',PostFormatResource::collection($group->posts),'all group posts',200);
    }
